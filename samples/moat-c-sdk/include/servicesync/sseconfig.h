...
#define SSE_VERSION_MINOR	(1)
#define SSE_VERSION_RELEASE	(0)
#define SSE_VERSION_STRING	"1.1.0"

#define SSE_SDK_VERSION_MAJOR	(1)
#define SSE_SDK_VERSION_MINOR	(1)
#define SSE_SDK_VERSION_RELEASE	(0)
#define SSE_SDK_VERSION_STRING	"1.1.0"
